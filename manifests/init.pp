...
class docker (
  ...
  Integer                                 $run_systemd_start_limit_interval_sec = $docker::params::run_systemd_start_limit_interval_sec,
  Integer                                 $run_systemd_start_limit_burst        = $docker::params::run_systemd_start_limit_burst,
